...
public class ChepaihaogenghuanEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ChepaihaogenghuanEntity() {
		
	}
	
	public ChepaihaogenghuanEntity(T t) {
		try {
	 ...
	 * 设置：新车牌号
	 */
	public void setXinchepaihao(String xinchepaihao) {
		this.xinchepaihao = xinchepaihao;
	}
	/**
	 * 获取：新车牌号
	 */
	public String getXinchepaihao() {
		return xinchepaihao;
	}
	/**
	 * 设置：备注
