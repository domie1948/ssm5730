          ...
          <el-form-item class="input" label="车牌号" prop="chepaihao">
              <el-input v-model="ruleForm.chepaihao" 
                placeholder="车牌号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="新车牌号" prop="xinchepaihao">
          <el-input v-model="ruleForm.xinchepaihao" 
              placeholder="新车牌号" clearable  :readonly="ro.xinchepaihao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="新车牌号" prop="xinchepaihao">
              <el-input v-model="ruleForm.xinchepaihao" 
                placeholder="新车牌号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.chepaihao = true;
            continue;
	            	            ...
	            	            if(o=='xinchepaihao'){
            this.ruleForm.xinchepaihao = obj[o];
	    this.ro.xinchepaihao = true;
            continue;
          }
	            	            if(o=='beizhu'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `chepaihaogenghuan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chepaihaogenghuanCrossAddOrUpdateFlag = false;
                  this.parent.search();
