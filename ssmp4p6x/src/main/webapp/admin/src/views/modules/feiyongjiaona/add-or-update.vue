          ...
          <el-form-item class="input" label="电费" prop="dianfei">
              <el-input v-model="ruleForm.dianfei" 
                placeholder="电费" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="卫生费" prop="weishengfei">
          <el-input v-model="ruleForm.weishengfei" 
              placeholder="卫生费" clearable  :readonly="ro.weishengfei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="卫生费" prop="weishengfei">
              <el-input v-model="ruleForm.weishengfei" 
                placeholder="卫生费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
...
export default {
  ...
  computed: {
                                                                                        zongjine: {
                                                                                                                                                                                                                                                  get: function () {
        return 0+parseFloat(this.ruleForm.shuifei)+parseFloat(this.ruleForm.dianfei)+parseFloat(this.ruleForm.weishengfei)+parseFloat(this.ruleForm.qita) || ''
      }
    },
                                  },
  created() {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.dianfei = true;
            continue;
	            	            ...
	            	            if(o=='weishengfei'){
            this.ruleForm.weishengfei = obj[o];
	    this.ro.weishengfei = true;
            continue;
          }
	            	            if(o=='qita'){
